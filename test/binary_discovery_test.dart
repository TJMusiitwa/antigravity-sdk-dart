...
void main() {
  ...
  group('BinaryDiscovery – version check and auto-update', () {
    ...
    test(
      ...
      // We expect it to try to auto-download because version is older than defaultVersion (0.1.11).
    ...
    test('returns cached path if cached binary version matches or is newer',
      ...
      // Write current default version (0.1.11)
      File('${binDir.path}/.version').writeAsStringSync('0.1.11');
