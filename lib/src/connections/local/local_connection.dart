...
class LocalConnectionStrategy implements ConnectionStrategy {
  ...
  String? get configuredBinaryPath => _configuredBinaryPath;
  ToolRunner get toolRunner => _toolRunner;
  HookRunner get hookRunner => _hookRunner;
  List<ModelTarget>? get models => _models;
  dynamic get systemInstructions => _systemInstructions;
  CapabilitiesConfig get capabilitiesConfig => _capabilitiesConfig;
  String? get conversationId => _conversationId;
  String? get saveDir => _saveDir;
  List<String> get workspaces => _workspaces;
  String? get appDataDir => _appDataDir;
  List<String> get skillsPaths => _skillsPaths;
  List<McpServerConfig> get mcpServers => _mcpServers;
  List<SubagentConfig> get subagents => _subagents;
...
class LiteRTConnectionStrategy extends LocalOpenAIConnectionStrategy {
  ...
  Future<void> start() async {
    ...
    final dir = Directory(appDataDir ?? defaultAppDataDir);
    if (!dir.existsSync()) {
